...
- URL del repositorio
- URL del servicio/API/institución balear a la que da soporte (p.ej. caib.es, uib.es, socib.eu)
Elimina esta sección si no aplica.
-->

| Proyecto | Servicio/Institución balear |
|----------|-------------------------------|
...
- URL del repositorio
- Motivo (archivado, no funcional, reemplazado, no específico de les Illes Balears, etc.)
Elimina esta sección si no aplica.
-->
