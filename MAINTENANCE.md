...
El criterio fundamental es: **se acepta software que da soporte específico a Illes Balears, no software hecho por alguien de Illes Balears.**

Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Illes Balears. No basta con que el autor resida o trabaje aquí. Un framework genérico creado por un developer de Illes Balears no pertenece a esta lista. Un cliente para la API de datos abiertos del gobierno de Illes Balears o una integración con servicios públicos de Illes Balears sí.

- **Sí:** Clientes de APIs de instituciones de Illes Balears, integraciones con servicios públicos regionales, scrapers de transporte o datos abiertos de Illes Balears.
- **No:** Librerías genéricas creadas por equipos de Illes Balears, software genérico cuyo autor simplemente reside en la comunidad.

Ver `AGENTS.md` (si existe) para criterios detallados adicionales.

## Revisar PRs

1. Comprobar que el proyecto **da soporte específico a Illes Balears** (no simplemente que el autor es de Illes Balears).
2. Verificar que la PR incluye la **URL del servicio o institución de Illes Balears** que el proyecto soporta.
...
4. Si el propietario del proyecto no ha sido notificado, abrir un issue de cortesía en su repo:
   - Título: `Incluido en awesome-illes-balears`
...
| No cumple criterios de inclusión | Eliminados por no ser específicos de Illes Balears |
