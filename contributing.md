# Contribuir a Awesome Illes Balears
...
- El proyecto debe **dar soporte específico a les Illes Balears** o incluir funcionalidades relevantes para usuarios en esta comunidad autónoma.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución balear** a la que el software da soporte (p.ej. caib.es, uib.es, socib.eu). Esto ayuda a verificar que el proyecto es relevante para les Illes Balears.
